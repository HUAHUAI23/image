...
import { Sparkles, Loader2, Wand2, UploadCloud, Trash2, Image as ImageIcon, Type } from 'lucide-react'
        ...
        <form action={action} className="flex flex-col h-full">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 p-8 flex flex-col gap-6 overflow-y-auto bg-background">
              ...
              {uploadedImageUrl && <input type="hidden" name="existingImageUrl" value={uploadedImageUrl} />}
            </div>
                ...
                {previewUrl ? (
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 text-muted-foreground p-6 text-center">
                    <div className={cn(
                      ...
                      type === 'image_to_image' ? "bg-primary/5 text-primary" : "bg-muted text-muted-foreground"
                    )}>
                    ...
                    <div className="space-y-1.5">
                      {!taskName.trim() ? (
                        ...
                        <>
                          ...
                          <p className="text-xs text-muted-foreground/60">支持 JPG, PNG (最大 10MB)</p>
                        </>
                      )}
                    </div>
                  </div>
